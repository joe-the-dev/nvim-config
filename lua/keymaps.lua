...
-- ========================================
-- Copilot (Insert mode):
-- Tab          - Accept Copilot suggestion (PRIORITY)
...
-- Down/Up      - Navigate completion items
-- Ctrl+J/K     - Navigate snippets

-- ========================================
-- COMMENTING (Comment.nvim)
-- ========================================
map('n', '<C-/>', 'gcc', { noremap = false, silent = true, desc = 'Toggle comment line' })
map('v', '<C-/>', 'gc', { noremap = false, silent = true, desc = 'Toggle comment selection' })
map('n', '<C-_>', 'gcc', { noremap = false, silent = true, desc = 'Toggle comment line (terminal fallback)' })
map('v', '<C-_>', 'gc', { noremap = false, silent = true, desc = 'Toggle comment selection (terminal fallback)' })
-- Note: In some terminals, Ctrl+/ sends Ctrl+_ instead
...
- Ctrl+/              Toggle comment line/selection

AUTO-COMPLETION:
- Ctrl+Space          Trigger completion
- Ctrl+N / Ctrl+P     Navigate completion items
- Enter               Confirm completion
- Down/Up             Alternative navigation

COPILOT (Insert mode only):
- Tab                 Accept Copilot suggestion (PRIORITY)
- Ctrl+J              Alternative accept
- Ctrl+]              Next suggestion
- Ctrl+[              Previous suggestion
- Ctrl+\              Manually trigger Copilot
...
NOTE: Tab key is reserved for Copilot. Use Ctrl+N/Ctrl+P for completion navigation.
--]]
